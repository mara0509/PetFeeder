...
# ==========================================
# ESP32 USB CONNECTION SETUP
# ==========================================
try:
    # Adjust /dev/ttyUSB0 if your Pi assigns a different port (like ttyACM0)
        ...
        try:
            ...
            if command_data.get("feed_command") == True:
                ...
                if esp32:
                    ...
                    print("➡️ent 'DISPENSE' command to ESP32 via USB!")
                else:
                    print("⚠️ESP32 not connected. Cannot dispense.")
        except Exception as e:
